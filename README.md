...
5. Создать подписанный тег `v0.1.0`
...
# Настройка Git
git config --global user.signingkey CBA869974992612E
git config --global commit.gpgsign true
git config --global user.email "taga07taga@gmail.com"

# Экспорт публичного ключа
gpg --armor --export CBA869974992612E
...
```
### 8.Результат
Ссылка:https://github.com/Tagir-iu/lab09/releases/tag/v0.1.0
